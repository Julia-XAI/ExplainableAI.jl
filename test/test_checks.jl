...
@test_throws ErrorException("Unknown layers or unsupported activation functions found in model") check_model(
    :LRP, Chain(Dense(2, 2, softmax)); verbose=false
)
@test_throws ErrorException("Unknown layers or unsupported activation functions found in model") check_model(
    :LRP, Chain(unknown_function); verbose=false
)
@test_throws ErrorException("Unknown layers or unsupported activation functions found in model") @suppress check_model(
    :LRP,
    Chain(
        unknown_function,
...
@test_throws ErrorException("Unknown layers or unsupported activation functions found in model") LRP(
